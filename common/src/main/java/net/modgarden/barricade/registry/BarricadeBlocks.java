...
public class BarricadeBlocks {
    ...
    public static final EntityBarrierBlock PLAYER_BARRIER = new EntityBarrierBlock(BlockedEntitiesComponent.fromHolders(Barricade.asResource("item/barricade/entity/player"), List.of(EntityType.PLAYER.builtInRegistryHolder()), false), BlockBehaviour.Properties.ofFullCopy(Blocks.BARRIER).dynamicShape());
    public static final EntityBarrierBlock MOB_BARRIER = new EntityBarrierBlock(BlockedEntitiesComponent.fromHolders(Barricade.asResource("item/barricade/entity/pig"), List.of(EntityType.PLAYER.builtInRegistryHolder()), true), BlockBehaviour.Properties.ofFullCopy(Blocks.BARRIER).dynamicShape());
    public static final EntityBarrierBlock PASSIVE_BARRIER = new EntityBarrierBlock(BlockedEntitiesComponent.fromTags(Barricade.asResource("item/barricade/entity/cow"), List.of(BarricadeTags.EntityTags.BLOCKED_BY_PASSIVE_BARRIER), false), BlockBehaviour.Properties.ofFullCopy(Blocks.BARRIER).dynamicShape());
    public static final EntityBarrierBlock HOSTILE_BARRIER = new EntityBarrierBlock(BlockedEntitiesComponent.fromTags(Barricade.asResource("item/barricade/entity/creeper"), List.of(BarricadeTags.EntityTags.BLOCKED_BY_HOSTILE_BARRIER), false), BlockBehaviour.Properties.ofFullCopy(Blocks.BARRIER).dynamicShape());
