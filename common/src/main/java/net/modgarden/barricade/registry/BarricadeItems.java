...
public class BarricadeItems {
    public static final BlockItem DIRECTIONAL_BARRIER = new ItemNameBlockItem(BarricadeBlocks.DIRECTIONAL_BARRIER, new Item.Properties().component(BarricadeComponents.BLOCKED_DIRECTIONS, BlockedDirectionsComponent.EMPTY));
    ...
    public static final BlockItem ENTITY_BARRIER = new EntityBarrierBlockItem(BarricadeBlocks.ENTITY_BARRIER, new Item.Properties().component(BarricadeComponents.BLOCKED_ENTITIES, BlockedEntitiesComponent.EMPTY));
    public static final BlockItem HOSTILE_BARRIER = new EntityBarrierBlockItem(BarricadeBlocks.ENTITY_BARRIER, new Item.Properties().component(BarricadeComponents.BLOCKED_ENTITIES, BlockedEntitiesComponent.fromTags(Barricade.asResource("item/barricade/entity/creeper"), List.of(BarricadeTags.EntityTags.BLOCKED_BY_HOSTILE_BARRIER), false)));
    ...
    public static final BlockItem PASSIVE_BARRIER = new EntityBarrierBlockItem(BarricadeBlocks.ENTITY_BARRIER, new Item.Properties().component(BarricadeComponents.BLOCKED_ENTITIES, BlockedEntitiesComponent.fromTags(Barricade.asResource("item/barricade/entity/cow"), List.of(BarricadeTags.EntityTags.BLOCKED_BY_PASSIVE_BARRIER), false)));
    ...
    public static void registerAll(RegistrationCallback<Item> callback) {
        callback.register(BuiltInRegistries.ITEM, Barricade.asResource("directional_barrier"), DIRECTIONAL_BARRIER);
        ...
        callback.register(BuiltInRegistries.ITEM, Barricade.asResource("entity_barrier"), ENTITY_BARRIER);
