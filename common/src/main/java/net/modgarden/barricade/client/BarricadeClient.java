...
public class BarricadeClient {
	...
	public static final GreenhouseConfigHolder<BarricadeClientConfig> CONFIG = GreenhouseConfigHolder.client("barricade",
					BarricadeClientConfig.CODEC,
					BarricadeClientConfig.DEFAULT,
					JsonCLang.INSTANCE)
			.schemaVersion(2)
